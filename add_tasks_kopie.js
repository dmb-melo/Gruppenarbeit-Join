...
//         if (prio !== selected) {
//             prio.classList.remove(`${prio.id}-active`);
//             document.querySelector(`.img-${divID}`).classList.remove('imgPrio-active');     //z.B. img-${divID} sollte img-PriorityLow      
//         }
//     }

//     selected.classList.toggle(`${divID}-active`);
//     document.querySelector(`.img-${divID}`).classList.toggle('imgPrio-active');
// }
    ...
    //         if (prio !== selected) {
    //             prio.classList.remove(`${prio.id}-active`);
    //             document.querySelector(`.img-${prio.id}`).classList.remove('imgPrio-active');
    //         }
    //     }
    ...
    //     // Get the updated selected priority div after class changes
    //     let updatedSelectedPriority = document.querySelector('.priorityUrgent-active, .priorityMedium-active, .priorityLow-active');
    //     let updatedPriorityContent = updatedSelectedPriority ? updatedSelectedPriority.innerHTML : '';

    //     // Store in priorityContentArray only if it doesn't have imgPrio-active class
    //     if (!document.querySelector('.imgPrio-active')) {
    //         priorityContentArray.unshift(updatedPriorityContent);
    //     }
    // }
...
//     // Check if the updatedSelectedPriority has imgPrio-active class and remove it before storage
//     if (document.querySelector('.imgPrio-active')) {
//         document.querySelector('.imgPrio-active').classList.remove('imgPrio-active');
//     }

//     // Store the updated priority content in the array
//     priorityContentArray.unshift(updatedPriorityContent);
// }
